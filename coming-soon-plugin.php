                        ...
                        <div id="content">
                            ...
                            <div id="options_tabs" class="ui-tabs ">
                                <ul class="options_tabs ui-tabs-nav" role="tablist" id="nav">
                                    <li class="active" role="tab" tabindex="0" aria-controls="option_general_default" aria-labelledby="ui-id-1" aria-selected="true"><div class="arrow"><div></div></div><a href="#" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-1"><img src="<?php echo plugins_url('images/general.png',__FILE__)?>" />&nbsp;&nbsp;<?php _e('General');?></a><span></span>
                                    </li>

                                    <li  role="tab" tabindex="-1" aria-controls="option_demo_header" aria-labelledby="ui-id-2" aria-selected="true"><div class="arrow"><div></div></div>
                                    <a href="#" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-2"><img src="<?php echo plugins_url('images/design.png',__FILE__)?>" />&nbsp;&nbsp;<?php _e('Design');?></a><span></span>
                                     ...
                                     <li role="tab" tabindex="-1" aria-controls="option_color_header" aria-labelledby="ui-id-5" aria-selected="false"><div class="arrow"><div></div></div><a href="#" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-5"><img src="<?php echo plugins_url('images/message.png',__FILE__)?>" />&nbsp;&nbsp;<?php _e('Notification');?></a><span></span>
                                     </li>

                                   <li><div class="arrow"><div></div></div><a href="<?php echo home_url(); ?>?my_preview=true&TB_iframe=true&width=500&height=532" title="<?php _e('Live Preview Window') ?>"  class="ui-tabs-anchor thickbox-preview"  ><img src="<?php echo plugins_url('images/icon_on.png',__FILE__)?>" />&nbsp;&nbsp;<?php _e('Live Preview');?> </a>
                                    </li>
