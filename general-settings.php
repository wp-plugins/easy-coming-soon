            ...
            <div class="option option-upload">
                ...
                <div class="section">
	                <div class="element">
                        ...
                        <input type="button" id="upload_button" value="Upload Background Image" class="upload_image_button"  /><br>
                        <?php if($current_options['upload_image']!=''){ ?><img  src="<?php echo $current_options['upload_image'];?>" height="60px" width="250px" />
                        <?php } ?>
                    </div>
                </div>
            </div>
