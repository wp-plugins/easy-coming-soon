	...
	<form method="post" action="#section_design">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Design Settings','commingsoon');?></h2></td>
				<td style="width:30%;">
					<div class="commingsoon_lite_settings_loding" id="commingsoon_loding_2_image"></div>
					<div class="commingsoon_lite_settings_massage" id="commingsoon_lite_settings_save_2_success" ><?php _e('Options data successfully Saved','commingsoon');?></div>
					<div class="commingsoon_lite_settings_massage" id="commingsoon_lite_settings_save_2_reset" ><?php _e('Options data successfully reset','commingsoon');?></div>
				</td>
		...
		<div class="section">
			<h3><?php _e('Background Color','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Headline font-color','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Headline font-size','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Headline font-style','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Description font-color','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Description font-size','commingsoon'); ?>  </h3>
		...
		<div class="section">
			<h3><?php _e('Description font-style','commingsoon'); ?>  </h3>
